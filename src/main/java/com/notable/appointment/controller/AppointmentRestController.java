...
import com.notable.appointment.service.AppointmentService;
...
public class AppointmentRestController {
	...
	/* *//**
			 * GET request to return all appointments based on a date range and ordered by
			 * price
			 **//*
				 * @RequestMapping(method = RequestMethod.GET) public List<Appointment>
				 * findByDateRangeSortedByPrice(@DateTimeFormat(iso =
				 * DateTimeFormat.ISO.DATE) @RequestParam("startDate") LocalDate startDate,
				 * 
				 * @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) @RequestParam("endDate")
				 * LocalDate endDate) { return
				 * appointmentService.findByDateRangeSortedByPrice(startDate, endDate); }
				 */
